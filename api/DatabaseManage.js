...
db.exec(
  ...
  ("house", "kaffir lily", "flower", "white", "sun", "summer", "Kaffir lily, also known as Clivia, is a flowering plant native to South Africa, featuring clusters of vibrant, trumpet shaped flowers atop long stalks. It is appreciated for its striking blooms, which can range in color from orange to red and yellow. Kaffir lilies are commonly cultivated as houseplants or in outdoor gardens, and they thrive in shaded or partially shaded areas."),
...
db.exec(
  ...
  ("garden", "apricot tree", "tree", "orange", "sun", "summer","The apricot is a small tree, 8 to 12 m tall, with a trunk up to 40 cm in diameter and a dense, spreading canopy. The leaves are ovate, 5 to 9 cm long and 4 to 8 cm wide, with a rounded base, a pointed tip and a finely serrated margin. The flowers are 2 to 4.5 cm in diameter, with five white to pinkish petals; they are produced singly or in pairs in early spring before the leaves. "),
...
db.exec(
  `
  INSERT INTO plantAbout (category, name, type, color, conditions, season,description ) VALUES
  ("tropical", "bird of paradise", "flower", "orange", "sun", "summer", "The bird of paradise is a very popular tropical flower that is widely used for wedding bouquets and table arrangements. The bird of paradise is also known as crane flower because of its shape that resembles a crane."),
  ...
  ("tropical", "hoya", "flower", "brown", "shade", "summer", "Hoya is a genus of 200 to 300 species of tropical plants in the dogbane family, Apocynaceae. Most are native to several countries of Asia such as Philippines, India, Thailand, Malaysia, Vietnam, Bangladesh, Indonesia, Polynesia, New Guinea, and vast variety of species could also be found in Australia."),
  ("tropical", "orange tree", "tree", "orange", "sun", "summer", "The orange tree is an evergreen, flowering tree, with an average height of 9 to 10 m, although some very old specimens can reach 15 m. Its oval leaves, alternately arranged, have crenulate margins and are 4 to 10 cm long. The orange tree is an evergreen, flowering tree, with an average height of 9 to 10 m, although some very old specimens can reach 15 m. "),
